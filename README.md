...
![PCB Automation System Circuit Diagram](./docs/circuit/system_circuit.png)

### Circuit Files

- [Circuit Diagram PDF](./docs/circuit/system_circuit.pdf)
- [Fritzing Source File](./docs/circuit/system_circuit.fzz)
